...
<div class="container">
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            ...
            <div>
                Customer Phone: <span class="px-3">{{$order_check->user->phone}},</span>  Payment method: <span class="px-3">{{$order_check->payment_method=="CashOn"?"CashOn Delivery":"Bkash Payment"}}, </span>  Delivered By:
                 <span class="px-3">{{$order_check->delivered_by}}.</span> 
            </div>
            <div>
